...
// 
//
// 文件名：GreaterThanEqualsFilter.cs
// 文件功能描述：表示大于或等于过滤条件。
//
//
...
namespace Useease.GeneralDataAccess
{
	...
	/// </summary>
	[Serializable]
	public class GreaterThanEqualsFilter : Filter
	{
		#region 构造函数
		...
		public GreaterThanEqualsFilter(String propertyName, Object propertyValue)
		...
		/// <param name="propertyValue">属性值。</param>
		public GreaterThanEqualsFilter(String entityPropertyName, String propertyName, Object propertyValue)
		...
		/// <param name="propertyValue">属性值。</param>
		public GreaterThanEqualsFilter(IList<String> propertyPath, Object propertyValue)
