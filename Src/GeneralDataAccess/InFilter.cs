...
namespace Useease.GeneralDataAccess
{
	...
	public class InFilter : Filter
	{
		...
		public InFilter(String propertyName, Object[] discreteValues)
		...
		public InFilter(String entityPropertyName, String propertyName, Object[] discreteValues)
		...
		/// <param name="discreteValues">值集合。</param>
		public InFilter(IList<String> propertyPath, Object[] discreteValues)
		...
		internal InFilter(String propertyName, QueryListBuilder builder)
		...
		/// <param name="propertyName">值属性名称。</param>
		/// <param name="builder">查询列表生成器。</param>
		internal InFilter(String entityPropertyName, String propertyName, QueryListBuilder builder)
		...
		/// <param name="propertyPath">属性路径。</param>
		/// <param name="builder">查询列表生成器。</param>
		internal InFilter(IList<String> propertyPath, QueryListBuilder builder)
