...
namespace Useease.GeneralDataAccess
{
	...
	/// </summary>
	[Serializable]
	public class LessThanEqualsFilter : Filter
	{
		#region 构造函数
		...
		public LessThanEqualsFilter(String propertyName, Object propertyValue)
		...
		/// <param name="propertyValue">属性值。</param>
		public LessThanEqualsFilter(String entityPropertyName, String propertyName, Object propertyValue)
		...
		/// <param name="propertyValue">属性值。</param>
		public LessThanEqualsFilter(IList<String> propertyPath, Object propertyValue)
