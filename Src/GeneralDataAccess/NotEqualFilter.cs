...
// 
//
// 文件名：NotEqualFilter.cs
// 文件功能描述：表示不等条件过滤器，支持实体过滤。
//
//
...
namespace Useease.GeneralDataAccess
{
	...
	public class NotEqualFilter : Filter
	{
		...
		public NotEqualFilter(String propertyName, Object propertyValue)
		...
		/// <param name="propertyValue">属性值。</param>
		public NotEqualFilter(String entityPropertyName, String propertyName, Object propertyValue)
		...
		/// <param name="propertyValue">属性值。</param>
		public NotEqualFilter(IList<String> propertyPath, Object propertyValue)
		...
		private void GenerateEntityFilterExpression(StringBuilder output)
		{
			...
			for (Int32 i = 0; i < EntityColumnFullNames.Length; i++)
			{
				...
				String paramName = ComposeParameter(parameters[0].Name);
