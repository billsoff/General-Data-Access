...
namespace Useease.GeneralDataAccess
{
	...
	public class GreaterThanFilter : Filter
	{
		...
		public GreaterThanFilter(String propertyName, Object propertyValue)
		...
		/// <param name="propertyValue">属性值。</param>
		public GreaterThanFilter(String entityPropertyName, String propertyName, Object propertyValue)
		...
		/// <param name="propertyValue">属性值。</param>
		public GreaterThanFilter(IList<String> propertyPath, Object propertyValue)
